...
## What Copilot Should Do When Unsure

1. Check `docs/ARCHITECTURE.md`
2. Check the current phase (Phase 0)
3. Look at existing components in `src/components/masterdata/`
4. Ask for clarification instead of inventing architecture
